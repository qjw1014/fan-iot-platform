...
export const menuRoutes: RouteRecordRaw[] = [
  ...
  { path: '/d200-field-mappings', name: 'd200-field-mappings', component: () => import('@/views/d200/D200FieldMappingView.vue'), meta: { title: 'D200字段映射', icon: 'Switch' } },
  { path: '/d200-raw-payloads', name: 'd200-raw-payloads', component: () => import('@/views/d200/D200RawPayloadView.vue'), meta: { title: 'D200原始数据', icon: 'Document' } },
  { path: '/d200-config-tasks', name: 'd200-config-tasks', component: () => import('@/views/d200/D200ConfigTaskView.vue'), meta: { title: 'D200远程配置', icon: 'Operation' } },
